...
extension UIColor {
    ...
    enum KColor {
        ...
        static var internalIndexBlue01: UIColor { UIColor(named: "InternalIndexBlue01")! }
        static var internalIndexBlue02: UIColor { UIColor(named: "InternalIndexBlue02")! }
        static var internalIndexCyan01: UIColor { UIColor(named: "InternalIndexCyan01")! }
        static var internalIndexCyan02: UIColor { UIColor(named: "InternalIndexCyan02")! }
        static var internalIndexGray01: UIColor { UIColor(named: "InternalIndexGray01")! }
        static var internalIndexGray02: UIColor { UIColor(named: "InternalIndexGray02")! }
        static var internalIndexGreen01: UIColor { UIColor(named: "InternalIndexGreen01")! }
        static var internalIndexGreen02: UIColor { UIColor(named: "InternalIndexGreen02")! }
        static var internalIndexRed01: UIColor { UIColor(named: "InternalIndexRed01")! }
        static var internalIndexRed02: UIColor { UIColor(named: "InternalIndexRed02")! }
