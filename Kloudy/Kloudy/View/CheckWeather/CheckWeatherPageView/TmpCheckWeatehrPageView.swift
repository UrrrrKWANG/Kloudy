//
//  TmpCheckWeatehrPageView.swift
//  Kloudy
//
//  Created by Byeon jinha on 2022/10/27.
//
...
class TmpCheckWeatherPageView: UIView, UICollectionViewDelegate, UICollectionViewDataSource,  UICollectionViewDelegateFlowLayout{
    ...
    lazy var scrollView: UIScrollView = {
        ...
        scrollView.showsHorizontalScrollIndicator = true // 가로스크롤인디케이터 숨김
        scrollView.showsVerticalScrollIndicator = true // 세로스크롤인디케이터 숨김
