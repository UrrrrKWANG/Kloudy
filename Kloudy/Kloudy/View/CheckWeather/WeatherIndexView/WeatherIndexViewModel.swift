...
struct WeatherIndexViewModel {
    ...
    var indexDummyData: [IndexDatas] = [
        IndexDatas(localName: "포항시 남구 지곡동", cityIndexData: [  weatherIndex(umbrella_index: Umbrella_index(status: 4, precipitaion_24h: 13.3, precipitaion_1h_max: 12.2, precipitation_3h_max: 16, wind: 15.5), mask_index: Mask_index(status: 1, pm25value: 12.5, pm10value: 402.1, pollen_index: 3), outer_index: Outer_index(status: 2, day_min_temperature: -16.5, morning_temperature: 16.7), laundry_index: Laundry_index(status: 0, humidity: 11.1, day_max_temperature: -12.7, daily_weather: 4), carwash_index: Carwash_index(status: 3, daily_weather: 2, day_max_temperature: -17.7, daily_precipitation: 12.2, tomorrow_weather: 1, tomorrow_precipitation: 12.2, weather_3Am7pm: "비가 내릴지도 모름", pm10grade: 3, pollen_index: 5), campare_index: Campare_index(yesterday_max_temperature: 22.2, yesterday_min_temperature: -21.1, today_max_temperature: -14.6, today_min_temperature: -20.1))]),
