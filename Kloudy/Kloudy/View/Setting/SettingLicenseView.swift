...
class SettingLicenseView: UIViewController {
    ...
    let licenses: [License] = [
        License(name: "Source of Weather Data: Korea Meteorological Administration / Air Korea", content: "Real-time observed data: May not be received depending on the local circumstances of the measuring station or the reception status of the data.")
    ]
